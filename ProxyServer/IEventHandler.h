...
public:
	...
	virtual void ClientGetData(const sockaddr_in sockaddr, const char *buffer, const size_t size_of_buffer) = 0;
	virtual void ClientSendData(const sockaddr_in sockaddr, const char *buffer, const size_t len) = 0;
	virtual void ServerGetData(const sockaddr_in sockaddr, const char *buffer, const size_t size_of_buffer) = 0;
