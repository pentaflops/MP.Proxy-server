...
public:
	...
	void ClientGetData(const sockaddr_in sockaddr, const char *buffer, const size_t size_of_buffer) const;
	void ClientSendData(const sockaddr_in sockaddr, const char *buffer, const size_t len) const;
	void ServerGetData(const sockaddr_in sockaddr, const char *buffer, const size_t size_of_buffer) const;
